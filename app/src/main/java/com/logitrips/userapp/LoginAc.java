                                    ...
                                    public void onCompleted(
                                        ...
                                        try {
                                            ...
                                            if (response != null) {
                                                ...
                                                Services.register(LoginAc.this, 2, user.getString("name"),
        ...
        if (v == login_btn) {
            if (email_edit.getText().toString().length() > 5 && password_edit.getText().toString().length() > 3) {
                if (Utils.isValidEmail(email_edit.getText()))
                    Services.login(LoginAc.this, email_edit.getText().toString(), password_edit.getText().toString());
                else
    ...
    public void onConnected(Bundle bundle) {
        ...
        try {
            if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
                ...
                Services.register(LoginAc.this,3,personName,email,"","",currentPerson.getCurrentLocation()+"",personPhotoUrl+"");
            } else {
