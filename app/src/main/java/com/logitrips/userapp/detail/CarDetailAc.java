...
public class CarDetailAc extends ActionBarActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private void initDet() {
        ...
        Log.e("rating", (float) car.getCar_rating() + "");
//        Drawable drawable = rating_star.getProgressDrawable();
//        drawable.setColorFilter(Color.parseColor("#fe7e17"), PorterDuff.Mode.SRC_ATOP);
//        Drawable d=rating_star.getIndeterminateDrawable();
//        d.setColorFilter(R.color.text_gray,PorterDuff.Mode.SRC_ATOP);
        ...
        date = (TextView) findViewById(R.id.det_date);
        duration = (TextView) findViewById(R.id.det_duration);
        ...
        driving_exp.setText((c.get(Calendar.YEAR) - car.getDriver_year()) + " years");

        knowledge.setText(car.getDriver_knowledge());
        for (int i = 0; i < car.getDriver_lang().length; i++) {
            lang_skills.append(car.getDriver_lang()[i] + ", ");
        }
